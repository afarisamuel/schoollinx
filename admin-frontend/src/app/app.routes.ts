...
export const routes: Routes = [
  ...
  { path: 'reset-password', loadComponent: () => import('./features/auth/reset-password/reset-password').then(m => m.ResetPasswordComponent) },
  {
    ...
    children: [
      ...
      { path: 'finance/transactions', loadComponent: () => import('./features/finance/transactions-ledger/transactions-ledger.component').then(m => m.TransactionsLedgerComponent) },
