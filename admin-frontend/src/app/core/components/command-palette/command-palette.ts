...
export class CommandPaletteComponent implements OnInit {
  ...
  navigationCommands: CommandItem[] = [
    ...
    { id: 'nav-jobs', title: 'Background Daemons & Scheduled Jobs', subtitle: 'Monitor cron tasks, billing engine & automated backups', category: 'NAVIGATION', icon: 'clock', action: () => this.navigate('/system/jobs') },
    { id: 'nav-directory', title: 'Global User Directory & Impersonation', subtitle: 'Search users across all tenant schemas & launch support SSO', category: 'NAVIGATION', icon: 'users', action: () => this.navigate('/users/directory') },
    { id: 'nav-audit', title: 'Platform Audit Logs', subtitle: 'Immutable administrative audit trail & compliance events', category: 'NAVIGATION', icon: 'shield', action: () => this.navigate('/audit-logs') },
