...
export class StudentSearchDropdownComponent implements OnInit {
  ...
  @Input() inputClass: string = 'w-full bg-bg-tertiary border border-border-primary rounded-xl pr-4 py-3 text-text-primary text-sm focus:outline-none focus:border-blue-500 transition-colors';
