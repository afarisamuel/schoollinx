...
type PaymentTransaction struct {
	...
	FiscalRecordID uuid.UUID     `json:"fiscal_record_id" gorm:"type:uuid;not null;index"`
	PayerID        uuid.UUID     `json:"payer_id" gorm:"type:uuid;not null;index"` // Guardian/User ID
